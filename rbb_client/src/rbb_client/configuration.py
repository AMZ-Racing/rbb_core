...
"""
    ...
    MODIFIED TO INCLUDE BEARER TOKEN AUTHENTICATION
...
class Configuration(object):
    ...
    def __init__(self):
        ...
        """
        # Default Base url
        self.host = "https://localhost/api/v0"
        # Default api client
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("rbb_client")
            ...
            'basicAuth':
                {
                    ...
                    'in': 'header',
                    'key': 'Authorization',
                    'value': self.get_bearer_auth_token() if self.use_bearer_auth else self.get_basic_auth_token()
                },
